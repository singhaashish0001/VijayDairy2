-- Vijay Dairy - PostgreSQL schema
-- Run against a fresh database: psql -U postgres -d vijay_dairy -f schema.sql
-- (create the database first: psql -U postgres -c "CREATE DATABASE vijay_dairy;")
